...
public class VAulaGenerico extends JFrame implements ActionListener, MouseListener{

	private JPanel JPanel_Cabecera, JPanel_Botones;
	private JButton Btn_AlumnoNuevo, Btn_BuscarAlumno, Btn_AsignarAGrupo, 
	 ...
	 */
	public VAulaGenerico(Empleado miEmpleado) {
	...
	private void iniciarComponentes() {
		...
		Btn_AlumnoNuevo = new JButton("AULA NUEVA");
		Btn_BuscarAlumno = new JButton("BUSCAR AULA");
		Btn_AsignarAGrupo = new JButton("DISPONIBILIDAD");
	...
	public void actionPerformed(ActionEvent e) {
		...
		VAulaDisponibilidad aulaDisponibilidad;
		...
		case "BUSCAR AULA":
			...
			aulaBuscar = new VAulaBuscar(miEmpleado, listaAulas);
			break;
		case "DISPONIBILIDAD":
			this.setVisible(false);
			this.dispose();
			aulaDisponibilidad = new VAulaDisponibilidad(miEmpleado);
			break;
		case "Inicio":
			this.setVisible(false);
			this.dispose();
