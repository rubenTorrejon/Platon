...
/**
 * Clase de vista que genera una ventana genérica de centro, donde podremos continuar la navegacion
 * hacia todas las opciones del centro.
 * 
 * @author Rubén Torrejón Espinosa
 *
 */
@SuppressWarnings("serial")
public class VCentroGenerico extends JFrame implements ActionListener, MouseListener{
	 ...
	 */
	public VCentroGenerico(Empleado miEmpleado) {
	...
	private void iniciarComponentes() {
		...
		Btn_AlumnoNuevo = new JButton("CENTRO NUEVO");
		Btn_BuscarAlumno = new JButton("BUSCAR CENTRO");
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "BUSCAR CENTRO":
			this.setVisible(false);
			this.dispose();
			CentroDAO miCentroDao = new CentroDAO();
