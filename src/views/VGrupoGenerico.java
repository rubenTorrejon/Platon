...
/**
 * Clase de vista que genera una ventana genérica de grupo, donde podremos continuar la navegacion
 * hacia todas las opciones del grupo.
 * 
 * @author Rubén Torrejón Espinosa
 *
 */
@SuppressWarnings("serial")
public class VGrupoGenerico extends JFrame implements ActionListener, MouseListener{

	private JPanel JPanel_Cabecera, JPanel_Botones;
	private JButton Btn_AlumnoNuevo, Btn_BuscarAlumno, Btn_Volver, Btn_Inicio, Btn_Config, Btn_Ayuda, Btn_Logout;
	 ...
	 */
	public VGrupoGenerico(Empleado miEmpleado) {
	...
	private void iniciarComponentes() {
		...
		Btn_AlumnoNuevo = new JButton("GRUPO NUEVO");
		Btn_BuscarAlumno = new JButton("BUSCAR GRUPO");
	...
	public void actionPerformed(ActionEvent e) {
		...
		VGrupoBuscar grupoBuscar;
		VGrupoAlumnos grupoAlumnos;
		...
		case "GRUPO NUEVO":
			...
			this.dispose();
			grupoNuevo = new VGrupoNuevo(miEmpleado);
			break;
		case "BUSCAR GRUPO":
			this.setVisible(false);
			this.dispose();
			ArrayList<Grupo> listaGrupos = miGrupoDao.buscarGrupos();
			grupoBuscar = new VGrupoBuscar(miEmpleado, listaGrupos);
			break;
		case "Ayuda":
			try
			{
